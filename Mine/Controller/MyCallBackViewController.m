...
@interface MyCallBackViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    UILabel *_label;
    UIButton *_leftBtn;
    UIView *_headView;
...
@implementation MyCallBackViewController
